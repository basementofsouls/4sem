...
void main() {
	...
	try
	{
		...
		/*	if (listen(cS, SOMAXCONN) == SOCKET_ERROR)
		...
		while (true) {
			...
			for (int i = 0; i <= 10001; i++)
			{
				...
				if ((lb = recvfrom(cS, ibuf, sizeof(ibuf), NULL, (sockaddr*)&client, &lc)) == SOCKET_ERROR)
					throw SetErrorMsgText("recv:", WSAGetLastError());
				//................................................................
				cout << ibuf << endl;
				Sleep(20);

				if ((lobuf = sendto(cS, ibuf, strlen(ibuf) + 1, NULL, (sockaddr*)&client, sizeof(client))) == SOCKET_ERROR)
					throw  SetErrorMsgText("recv:", WSAGetLastError());
